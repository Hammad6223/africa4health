...
const Hero = () => {
  return (
    <div className="relative flex items-center h-screen overflow-hidden">
      ...
      {/* Left Content */}
      <div className="relative z-10 lg:ps-[20px] xl:ps-[120px] flex flex-col gap-6 max-w-3xl">
      ...
      <div className="absolute bottom-[22px] px-4 left-1/2 transform -translate-x-1/2 rounded-xl px-8 py-4 z-20 w-full max-w-7xl bg-[#FE9430] flex justify-between">
        <div>
          <p className="lg:text-[26px] xl:text-[32px] font-extrabold text-[#621843] text-center"> 350+ <span className="text-white">villages</span></p>
          <p className="lg:text-[18px] xl:text-[24px] font-semi-bold text-white max-w-2xs text-center">Supported with essential resources and services</p>
        </div>

        <div className="tect-center">
          <p className="text-[32px] font-extrabold text-[#621843] text-center">210+ <span className="text-white">medical camps</span></p>
          <p className="text-[24px] font-semi-bold text-white max-w-2xs text-center">Conducted in underserved regions</p>
        </div>
      </div>

      <div className="absolute bottom-10 z-20 left-0 lg:left-50 xl:left-130 bg-[#621843] text-center px-6 py-4">
        <p className="text-[20px] lg:text-[28px] xl:text-[32px] font-extrabold text-[#FE9430]">95K+ <span className="text-white">patients treated</span></p>
